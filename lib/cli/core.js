...
var CORE = [{
  class: '项目类',
  children: [{ name: 'init-project', abbr: 'ipt', comment: 'open the guide of init a project [打开项目初始引导]' }, { name: 'init-core', abbr: 'icr', comment: 'create core.config.js [创建配置文件]' }, { name: 'xmind-plan', abbr: 'xplan', comment: 'generates project plan files from xmind tree [根据xmind创建项目评估表和工作流表]' }, { name: 'check-project-framework', abbr: 'cprfr', comment: 'check project framework 查看项目架构说明' }]
}, {
  class: '业务类',
  ...
  class: '补全类',
  children: [{ name: 'create-snippet', abbr: 'crsn', comment: 'create snippet [创建项目补全]' }, { name: 'delete-snippet', abbr: 'dlsn', comment: 'delete snippet [删除项目补全]' }, { name: 'set-snippet', abbr: 'slsn', comment: 'set snippet range [设置项目补全范围]' }]
}, {
  class: '数据类',
