...
var projectBasePath = _src.PROJECT_BASE_PATH;
...
try {
  ...
  if (!fs.existsSync(path.join(projectBasePath, './page-data.js'))) {
    ...
    (0, _createPageData2.default)(projectBasePath);
  } else {
...
var pages = (0, _getPages2.default)(projectBasePath);
...
(0, _expand2.default)(projectBasePath, app, function () {
